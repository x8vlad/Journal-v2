    ...
    $("#user-option").on("change", function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                let newBody = $(response).find("#table-body").html();
...
//         $.ajax({
//             method: "POST",
//             url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/add_announcement.php",
//             dataType: "json",
//             data: {
//                 title: title,
//                 content: content,
...
//
//                     setTimeout(function () {
//                         window.location.href = "/home/kaine/PhpstormProjects/Journal-v2" + "view/ogloszenia.tpl.php";
//                     }, 200);
//
...
//         $.ajax({
//             url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/edit_announcement.php",
//             method: "POST",
...
//                 }
//                 $.ajax({
//                     url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/table-contentAJAX.php",
//                     method: "POST",
//                     success: function (response) {
//                         // console.log("NORM");
//                         // console.log(response);
...
//             url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/remove_announcement.php",
...
//     // attendance:
//     $.ajax({
//         url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/get_attendance_link.php",
//         dataType: "json",
...
//             console.log(url);
//             $.ajax({
//                 url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/getUser.php",
//                 dataType: "json",
//                 success: function(response){
//                     if(response.status == "success"){
...
//
//                     // $.ajax({
//                     //   url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/attendance.php",
...
//         event.preventDefault();
//         $.ajax({
//             url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/remove-record.php",
//             method: "POST",
//             data: { id: id },
//             beforeSend: loading,
//             success: function () {
...
//         $.ajax({
//             method: "POST",
//             url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/login.php",
//             data: {
//                 // !!!!!
//                 login: loginSignIn,
//                 password: pwdSignIn,
...
//
//         $.ajax({
//             url: "/home/kaine/PhpstormProjects/Journal-v2" + "controllers/logOut.php",
//             dataType: "json",
//             success: function(response){
//                 if(response.status == "success"){
//                     $("#loginText").hide();
